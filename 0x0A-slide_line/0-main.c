...
int main()
{
	...
	/* test 17 */
	int test17[3] = {2, 0, 2};
	int test17_expected[3] = {4, 0, 0};
	print_array(test17, 3);
	slide_line(test17, 3, SLIDE_LEFT);
	if (compare_arrays(test17, test17_expected, 3))
		printf("OK\n\n");
	else
	{
		printf("FAIL\n\n");
		print_my_array(test17, 3);
		print_expected_array(test17_expected, 3);
	}
	printf("======================================\n\n");
	/* test 18 */
	int test18[3] = {0, 0, 2};
	int test18_expected[3] = {2, 0, 0};
	print_array(test18, 3);
	slide_line(test18, 3, SLIDE_LEFT);
	if (compare_arrays(test18, test18_expected, 3))
		printf("OK\n\n");
	else
	{
		printf("FAIL\n\n");
		print_my_array(test18, 3);
		print_expected_array(test18_expected, 3);
	}
	printf("======================================\n\n");
	/* test 21 */
	int test21[5] = {2, 4, 8, 8, 16};
	int test21_expected[5] = {2, 4, 16, 16, 0};
	print_array(test21, 5);
	slide_line(test21, 5, SLIDE_LEFT);
	if (compare_arrays(test21, test21_expected, 5))
		printf("OK\n\n");
	else
	{
		printf("FAIL\n\n");
		print_my_array(test21, 5);
		print_expected_array(test21_expected, 5);
	}
	printf("======================================\n\n");
	printf("\n\n\n");
	/* SLIDE RIGHT TESTS */
	...
	/* test 16 */
	int test16[3] = {2, 0, 2};
	int test16_expected[3] = {0, 0, 4};
	print_array(test16, 3);
	slide_line(test16, 3, SLIDE_RIGHT);
	if (compare_arrays(test16, test16_expected, 3))
		printf("OK\n\n");
	else
	{
		printf("FAIL\n\n");
		print_my_array(test16, 3);
		print_expected_array(test16_expected, 3);
	}
	printf("======================================\n\n");
	/* test 19 */
	int test19[3] = {2, 0, 0};
	int test19_expected[3] = {0, 0, 2};
	print_array(test19, 3);
	slide_line(test19, 3, SLIDE_RIGHT);
	if (compare_arrays(test19, test19_expected, 3))
		printf("OK\n\n");
	else
	{
		printf("FAIL\n\n");
		print_my_array(test19, 3);
		print_expected_array(test19_expected, 3);
	}
	printf("======================================\n\n");
	/* test 20 */
	int test20[5] = {2, 4, 8, 8, 16};
	int test20_expected[5] = {0, 2, 4, 16, 16};
	print_array(test20, 5);
	slide_line(test20, 5, SLIDE_RIGHT);
	if (compare_arrays(test20, test20_expected, 5))
		printf("OK\n\n");
	else
	{
		printf("FAIL\n\n");
		print_my_array(test20, 5);
		print_expected_array(test20_expected, 5);
	}
	printf("======================================\n\n");
	return (EXIT_SUCCESS);
}